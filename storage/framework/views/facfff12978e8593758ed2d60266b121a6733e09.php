                                        ...
                                        <div class="d-flex gap-2 justify-content-center">
                                            <div class="edit">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Product edit')): ?>
                                                    <button class="btn btn-sm btn-success edit-item-btn"><a href="<?php echo e(route('product.edit', encrypt($product->id))); ?>" class="text-white"><i class="ri-edit-line"></i></a></button>
                                                <?php endif; ?>
                                            </div>
                                            <div class="remove">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                            <button type="button" class="btn w-sm btn-light"
                                                                ...
                                                                <form action="<?php echo e(route('product.destroy',encrypt($product->id))); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New-velzon-15-11-2023\resources\views/Product-Management/Products/list.blade.php ENDPATH**/ ?>