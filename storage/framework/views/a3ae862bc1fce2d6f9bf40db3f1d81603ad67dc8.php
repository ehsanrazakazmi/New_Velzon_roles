    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- start card-body -->
                <div class="card-body">
                    <form action="<?php echo e(route('product.update', encrypt($product->id))); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <div class="form-floating">
                            <div class="mb-3">
                                <label for="name" class="form-label">Product Name</label>
                                <input type="text" name="name" value="<?php echo e($product->name); ?>" class="form-control" placeholder="Name" required>
                            </div>
                            
                            <div class="mb-3">
                                <label for="detail" class="form-label">Details</label>
                                <textarea class="form-control" style="height:150px" name="detail" placeholder="Detail" required><?php echo e($product->detail); ?></textarea>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New-velzon-15-11-2023\resources\views/Product-Management/Products/edit.blade.php ENDPATH**/ ?>
